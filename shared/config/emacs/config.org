...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Patrick Lindsay"
    user-mail-address "pat@thatdarnpat.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/plindsay/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/plindsay/bin" "/profile/bin" "/Users/plindsay/.npm-packages/bin" "/Users/plindsay/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
